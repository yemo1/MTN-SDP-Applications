...
namespace MTNSAWeb.DSync {
    ...
    [System.SerializableAttribute()]
    public class NamedParameterList : System.Collections.Generic.List<MTNSAWeb.DSync.NamedParameter> {
    }
    ...
    public partial class SyncResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private MTNSAWeb.DSync.NamedParameterList extensionInfoField;
        ...
        public MTNSAWeb.DSync.NamedParameterList extensionInfo {
            get {
    ...
    public interface DataSyncSoap {
        ...
        MTNSAWeb.DSync.syncOrderRelationResponse syncOrderRelation(MTNSAWeb.DSync.syncOrderRelationRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<MTNSAWeb.DSync.syncOrderRelationResponse> syncOrderRelationAsync(MTNSAWeb.DSync.syncOrderRelationRequest request);
    }
    ...
    public partial class syncOrderRelationRequest {
        ...
        public MTNSAWeb.DSync.syncOrderRelationRequestBody Body;
        
        public syncOrderRelationRequest() {
        }
        
        public syncOrderRelationRequest(MTNSAWeb.DSync.syncOrderRelationRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class syncOrderRelationRequestBody {
        ...
        public MTNSAWeb.DSync.UserID userID;
        ...
        public syncOrderRelationRequestBody(MTNSAWeb.DSync.UserID userID, string spID, string productID, string serviceID, string serviceList, int updateType, string updateTime, string updateDesc, string effectiveTime, string expiryTime, MTNSAWeb.DSync.NamedParameterList extensionInfo) {
            this.userID = userID;
            this.spID = spID;
    ...
    public partial class syncOrderRelationResponse {
        ...
        public MTNSAWeb.DSync.syncOrderRelationResponseBody Body;
        
        public syncOrderRelationResponse() {
        }
        
        public syncOrderRelationResponse(MTNSAWeb.DSync.syncOrderRelationResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class syncOrderRelationResponseBody {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=0)]
        public MTNSAWeb.DSync.SyncResponse syncOrderRelationResult;
        
        public syncOrderRelationResponseBody() {
        }
        
        public syncOrderRelationResponseBody(MTNSAWeb.DSync.SyncResponse syncOrderRelationResult) {
            this.syncOrderRelationResult = syncOrderRelationResult;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface DataSyncSoapChannel : MTNSAWeb.DSync.DataSyncSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DataSyncSoapClient : System.ServiceModel.ClientBase<MTNSAWeb.DSync.DataSyncSoap>, MTNSAWeb.DSync.DataSyncSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        MTNSAWeb.DSync.syncOrderRelationResponse MTNSAWeb.DSync.DataSyncSoap.syncOrderRelation(MTNSAWeb.DSync.syncOrderRelationRequest request) {
            return base.Channel.syncOrderRelation(request);
        }
        
        public MTNSAWeb.DSync.SyncResponse syncOrderRelation(MTNSAWeb.DSync.UserID userID, string spID, string productID, string serviceID, string serviceList, int updateType, string updateTime, string updateDesc, string effectiveTime, string expiryTime, MTNSAWeb.DSync.NamedParameterList extensionInfo) {
            MTNSAWeb.DSync.syncOrderRelationRequest inValue = new MTNSAWeb.DSync.syncOrderRelationRequest();
            inValue.Body = new MTNSAWeb.DSync.syncOrderRelationRequestBody();
            ...
            MTNSAWeb.DSync.syncOrderRelationResponse retVal = ((MTNSAWeb.DSync.DataSyncSoap)(this)).syncOrderRelation(inValue);
            return retVal.Body.syncOrderRelationResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<MTNSAWeb.DSync.syncOrderRelationResponse> MTNSAWeb.DSync.DataSyncSoap.syncOrderRelationAsync(MTNSAWeb.DSync.syncOrderRelationRequest request) {
            return base.Channel.syncOrderRelationAsync(request);
        }
        
        public System.Threading.Tasks.Task<MTNSAWeb.DSync.syncOrderRelationResponse> syncOrderRelationAsync(MTNSAWeb.DSync.UserID userID, string spID, string productID, string serviceID, string serviceList, int updateType, string updateTime, string updateDesc, string effectiveTime, string expiryTime, MTNSAWeb.DSync.NamedParameterList extensionInfo) {
            MTNSAWeb.DSync.syncOrderRelationRequest inValue = new MTNSAWeb.DSync.syncOrderRelationRequest();
            inValue.Body = new MTNSAWeb.DSync.syncOrderRelationRequestBody();
            inValue.Body.userID = userID;
            inValue.Body.spID = spID;
            ...
            inValue.Body.expiryTime = expiryTime;
            inValue.Body.extensionInfo = extensionInfo;
            return ((MTNSAWeb.DSync.DataSyncSoap)(this)).syncOrderRelationAsync(inValue);
        }
    }
}
