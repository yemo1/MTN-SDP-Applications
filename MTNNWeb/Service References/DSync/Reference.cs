...
namespace MTNNWeb.DSync {
    ...
    [System.SerializableAttribute()]
    public class NamedParameterList : System.Collections.Generic.List<MTNNWeb.DSync.NamedParameter> {
    }
    ...
    public partial class SyncResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private MTNNWeb.DSync.NamedParameterList extensionInfoField;
        ...
        public MTNNWeb.DSync.NamedParameterList extensionInfo {
            get {
    ...
    public interface DataSyncSoap {
        ...
        MTNNWeb.DSync.syncOrderRelationResponse syncOrderRelation(MTNNWeb.DSync.syncOrderRelationRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<MTNNWeb.DSync.syncOrderRelationResponse> syncOrderRelationAsync(MTNNWeb.DSync.syncOrderRelationRequest request);
    }
    ...
    public partial class syncOrderRelationRequest {
        ...
        public MTNNWeb.DSync.syncOrderRelationRequestBody Body;
        
        public syncOrderRelationRequest() {
        }
        
        public syncOrderRelationRequest(MTNNWeb.DSync.syncOrderRelationRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class syncOrderRelationRequestBody {
        ...
        public MTNNWeb.DSync.UserID userID;
        ...
        public syncOrderRelationRequestBody(MTNNWeb.DSync.UserID userID, string spID, string productID, string serviceID, string serviceList, int updateType, string updateTime, string updateDesc, string effectiveTime, string expiryTime, MTNNWeb.DSync.NamedParameterList extensionInfo) {
            this.userID = userID;
            this.spID = spID;
    ...
    public partial class syncOrderRelationResponse {
        ...
        public MTNNWeb.DSync.syncOrderRelationResponseBody Body;
        
        public syncOrderRelationResponse() {
        }
        
        public syncOrderRelationResponse(MTNNWeb.DSync.syncOrderRelationResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class syncOrderRelationResponseBody {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=0)]
        public MTNNWeb.DSync.SyncResponse syncOrderRelationResult;
        
        public syncOrderRelationResponseBody() {
        }
        
        public syncOrderRelationResponseBody(MTNNWeb.DSync.SyncResponse syncOrderRelationResult) {
            this.syncOrderRelationResult = syncOrderRelationResult;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface DataSyncSoapChannel : MTNNWeb.DSync.DataSyncSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DataSyncSoapClient : System.ServiceModel.ClientBase<MTNNWeb.DSync.DataSyncSoap>, MTNNWeb.DSync.DataSyncSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        MTNNWeb.DSync.syncOrderRelationResponse MTNNWeb.DSync.DataSyncSoap.syncOrderRelation(MTNNWeb.DSync.syncOrderRelationRequest request) {
            return base.Channel.syncOrderRelation(request);
        }
        
        public MTNNWeb.DSync.SyncResponse syncOrderRelation(MTNNWeb.DSync.UserID userID, string spID, string productID, string serviceID, string serviceList, int updateType, string updateTime, string updateDesc, string effectiveTime, string expiryTime, MTNNWeb.DSync.NamedParameterList extensionInfo) {
            MTNNWeb.DSync.syncOrderRelationRequest inValue = new MTNNWeb.DSync.syncOrderRelationRequest();
            inValue.Body = new MTNNWeb.DSync.syncOrderRelationRequestBody();
            ...
            MTNNWeb.DSync.syncOrderRelationResponse retVal = ((MTNNWeb.DSync.DataSyncSoap)(this)).syncOrderRelation(inValue);
            return retVal.Body.syncOrderRelationResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<MTNNWeb.DSync.syncOrderRelationResponse> MTNNWeb.DSync.DataSyncSoap.syncOrderRelationAsync(MTNNWeb.DSync.syncOrderRelationRequest request) {
            return base.Channel.syncOrderRelationAsync(request);
        }
        
        public System.Threading.Tasks.Task<MTNNWeb.DSync.syncOrderRelationResponse> syncOrderRelationAsync(MTNNWeb.DSync.UserID userID, string spID, string productID, string serviceID, string serviceList, int updateType, string updateTime, string updateDesc, string effectiveTime, string expiryTime, MTNNWeb.DSync.NamedParameterList extensionInfo) {
            MTNNWeb.DSync.syncOrderRelationRequest inValue = new MTNNWeb.DSync.syncOrderRelationRequest();
            inValue.Body = new MTNNWeb.DSync.syncOrderRelationRequestBody();
            inValue.Body.userID = userID;
            inValue.Body.spID = spID;
            ...
            inValue.Body.expiryTime = expiryTime;
            inValue.Body.extensionInfo = extensionInfo;
            return ((MTNNWeb.DSync.DataSyncSoap)(this)).syncOrderRelationAsync(inValue);
        }
    }
}
