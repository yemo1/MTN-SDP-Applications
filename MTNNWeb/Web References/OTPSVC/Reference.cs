...
namespace MTNNWeb.OTPSVC
{
    ...
    public partial class SubscriberConsentService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public SubscriberConsentService() {
            this.Url = string.Format(global::MTNNWeb.Properties.Settings.Default.MTNNWeb_OTPSVC_SubscriberConsentService, ((AppUtil.TestMode == 0) ? AppUtil.LiveIP : AppUtil.TestIP));
