...
namespace MTNNWeb.SNSVC {
    ...
    public partial class SmsNotificationManagerService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public SmsNotificationManagerService() {
            this.Url = string.Format(global::MTNNWeb.Properties.Settings.Default.MTNNWeb_SNSVC_SmsNotificationManagerService, ((AppUtil.TestMode == 0) ? AppUtil.LiveIP : AppUtil.TestIP));
