...
namespace MTNNSub.DSync {
    ...
    [System.SerializableAttribute()]
    public class NamedParameterList : System.Collections.Generic.List<MTNNSub.DSync.NamedParameter> {
    }
    ...
    public partial class SyncResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private MTNNSub.DSync.NamedParameterList extensionInfoField;
        ...
        public MTNNSub.DSync.NamedParameterList extensionInfo {
            get {
    ...
    public interface DataSyncSoap {
        ...
        MTNNSub.DSync.syncOrderRelationResponse syncOrderRelation(MTNNSub.DSync.syncOrderRelationRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<MTNNSub.DSync.syncOrderRelationResponse> syncOrderRelationAsync(MTNNSub.DSync.syncOrderRelationRequest request);
    }
    ...
    public partial class syncOrderRelationRequest {
        ...
        public MTNNSub.DSync.syncOrderRelationRequestBody Body;
        
        public syncOrderRelationRequest() {
        }
        
        public syncOrderRelationRequest(MTNNSub.DSync.syncOrderRelationRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class syncOrderRelationRequestBody {
        ...
        public MTNNSub.DSync.UserID userID;
        ...
        public syncOrderRelationRequestBody(MTNNSub.DSync.UserID userID, string spID, string productID, string serviceID, string serviceList, int updateType, string updateTime, string updateDesc, string effectiveTime, string expiryTime, MTNNSub.DSync.NamedParameterList extensionInfo) {
            this.userID = userID;
            this.spID = spID;
    ...
    public partial class syncOrderRelationResponse {
        ...
        public MTNNSub.DSync.syncOrderRelationResponseBody Body;
        
        public syncOrderRelationResponse() {
        }
        
        public syncOrderRelationResponse(MTNNSub.DSync.syncOrderRelationResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class syncOrderRelationResponseBody {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=0)]
        public MTNNSub.DSync.SyncResponse syncOrderRelationResult;
        
        public syncOrderRelationResponseBody() {
        }
        
        public syncOrderRelationResponseBody(MTNNSub.DSync.SyncResponse syncOrderRelationResult) {
            this.syncOrderRelationResult = syncOrderRelationResult;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface DataSyncSoapChannel : MTNNSub.DSync.DataSyncSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DataSyncSoapClient : System.ServiceModel.ClientBase<MTNNSub.DSync.DataSyncSoap>, MTNNSub.DSync.DataSyncSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        MTNNSub.DSync.syncOrderRelationResponse MTNNSub.DSync.DataSyncSoap.syncOrderRelation(MTNNSub.DSync.syncOrderRelationRequest request) {
            return base.Channel.syncOrderRelation(request);
        }
        
        public MTNNSub.DSync.SyncResponse syncOrderRelation(MTNNSub.DSync.UserID userID, string spID, string productID, string serviceID, string serviceList, int updateType, string updateTime, string updateDesc, string effectiveTime, string expiryTime, MTNNSub.DSync.NamedParameterList extensionInfo) {
            MTNNSub.DSync.syncOrderRelationRequest inValue = new MTNNSub.DSync.syncOrderRelationRequest();
            inValue.Body = new MTNNSub.DSync.syncOrderRelationRequestBody();
            ...
            MTNNSub.DSync.syncOrderRelationResponse retVal = ((MTNNSub.DSync.DataSyncSoap)(this)).syncOrderRelation(inValue);
            return retVal.Body.syncOrderRelationResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<MTNNSub.DSync.syncOrderRelationResponse> MTNNSub.DSync.DataSyncSoap.syncOrderRelationAsync(MTNNSub.DSync.syncOrderRelationRequest request) {
            return base.Channel.syncOrderRelationAsync(request);
        }
        
        public System.Threading.Tasks.Task<MTNNSub.DSync.syncOrderRelationResponse> syncOrderRelationAsync(MTNNSub.DSync.UserID userID, string spID, string productID, string serviceID, string serviceList, int updateType, string updateTime, string updateDesc, string effectiveTime, string expiryTime, MTNNSub.DSync.NamedParameterList extensionInfo) {
            MTNNSub.DSync.syncOrderRelationRequest inValue = new MTNNSub.DSync.syncOrderRelationRequest();
            inValue.Body = new MTNNSub.DSync.syncOrderRelationRequestBody();
            inValue.Body.userID = userID;
            inValue.Body.spID = spID;
            ...
            inValue.Body.expiryTime = expiryTime;
            inValue.Body.extensionInfo = extensionInfo;
            return ((MTNNSub.DSync.DataSyncSoap)(this)).syncOrderRelationAsync(inValue);
        }
    }
}
