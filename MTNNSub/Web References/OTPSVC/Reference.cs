...
namespace MTNNSub.OTPSVC {
    ...
    public partial class SubscriberConsentService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public SubscriberConsentService() {
            this.Url = string.Format(global::MTNNSub.Properties.Settings.Default.MTNNSub_OTPSVC_SubscriberConsentService, ((AppUtil.TestMode == 0) ? AppUtil.LiveIP : AppUtil.TestIP));
