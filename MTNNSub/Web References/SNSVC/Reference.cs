...
namespace MTNNSub.SNSVC {
    ...
    public partial class SmsNotificationManagerService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public SmsNotificationManagerService() {
            this.Url = string.Format(global::MTNNSub.Properties.Settings.Default.MTNNSub_SNSVC_SmsNotificationManagerService, ((AppUtil.TestMode == 0) ? AppUtil.LiveIP : AppUtil.TestIP));
