...
namespace MTNNSub
{
    public partial class PostWeb : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                //http://368795-web2/MTNNSub/PostWeb.aspx?svcID=234012000004575&searchkey=144&phone=2348030643007&amount=1000&tk=2
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                sncProduct = db.SyncOrderProducts.FirstOrDefault(f => f.ServiceID == AppUtil.serviceId);
