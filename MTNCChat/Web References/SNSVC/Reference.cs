...
namespace MTNCChat.SNSVC {
    ...
    public partial class SmsNotificationManagerService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public SmsNotificationManagerService() {
            this.Url = string.Format(global::MTNCChat.Properties.Settings.Default.MTNCChat_SNSVC_SmsNotificationManagerService, ((AppUtil.TestMode == 0) ? AppUtil.LiveIP : AppUtil.TestIP)); 
