...
namespace MTNCChat.OTPSVC {
    ...
    public partial class SubscriberConsentService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public SubscriberConsentService() {
            this.Url = string.Format(global::MTNCChat.Properties.Settings.Default.MTNCChat_OTPSVC_SubscriberConsentService, ((AppUtil.TestMode == 0) ? AppUtil.LiveIP : AppUtil.TestIP));
