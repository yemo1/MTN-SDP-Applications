...
namespace MTNCInfo.DSync {
    ...
    [System.SerializableAttribute()]
    public class NamedParameterList : System.Collections.Generic.List<MTNCInfo.DSync.NamedParameter> {
    }
    ...
    public partial class SyncResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private MTNCInfo.DSync.NamedParameterList extensionInfoField;
        ...
        public MTNCInfo.DSync.NamedParameterList extensionInfo {
            get {
    ...
    public interface DataSyncSoap {
        ...
        MTNCInfo.DSync.syncOrderRelationResponse syncOrderRelation(MTNCInfo.DSync.syncOrderRelationRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<MTNCInfo.DSync.syncOrderRelationResponse> syncOrderRelationAsync(MTNCInfo.DSync.syncOrderRelationRequest request);
    }
    ...
    public partial class syncOrderRelationRequest {
        ...
        public MTNCInfo.DSync.syncOrderRelationRequestBody Body;
        
        public syncOrderRelationRequest() {
        }
        
        public syncOrderRelationRequest(MTNCInfo.DSync.syncOrderRelationRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class syncOrderRelationRequestBody {
        ...
        public MTNCInfo.DSync.UserID userID;
        ...
        public syncOrderRelationRequestBody(MTNCInfo.DSync.UserID userID, string spID, string productID, string serviceID, string serviceList, int updateType, string updateTime, string updateDesc, string effectiveTime, string expiryTime, MTNCInfo.DSync.NamedParameterList extensionInfo) {
            this.userID = userID;
            this.spID = spID;
    ...
    public partial class syncOrderRelationResponse {
        ...
        public MTNCInfo.DSync.syncOrderRelationResponseBody Body;
        
        public syncOrderRelationResponse() {
        }
        
        public syncOrderRelationResponse(MTNCInfo.DSync.syncOrderRelationResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class syncOrderRelationResponseBody {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false, Order=0)]
        public MTNCInfo.DSync.SyncResponse syncOrderRelationResult;
        
        public syncOrderRelationResponseBody() {
        }
        
        public syncOrderRelationResponseBody(MTNCInfo.DSync.SyncResponse syncOrderRelationResult) {
            this.syncOrderRelationResult = syncOrderRelationResult;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface DataSyncSoapChannel : MTNCInfo.DSync.DataSyncSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DataSyncSoapClient : System.ServiceModel.ClientBase<MTNCInfo.DSync.DataSyncSoap>, MTNCInfo.DSync.DataSyncSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        MTNCInfo.DSync.syncOrderRelationResponse MTNCInfo.DSync.DataSyncSoap.syncOrderRelation(MTNCInfo.DSync.syncOrderRelationRequest request) {
            return base.Channel.syncOrderRelation(request);
        }
        
        public MTNCInfo.DSync.SyncResponse syncOrderRelation(MTNCInfo.DSync.UserID userID, string spID, string productID, string serviceID, string serviceList, int updateType, string updateTime, string updateDesc, string effectiveTime, string expiryTime, MTNCInfo.DSync.NamedParameterList extensionInfo) {
            MTNCInfo.DSync.syncOrderRelationRequest inValue = new MTNCInfo.DSync.syncOrderRelationRequest();
            inValue.Body = new MTNCInfo.DSync.syncOrderRelationRequestBody();
            ...
            MTNCInfo.DSync.syncOrderRelationResponse retVal = ((MTNCInfo.DSync.DataSyncSoap)(this)).syncOrderRelation(inValue);
            return retVal.Body.syncOrderRelationResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<MTNCInfo.DSync.syncOrderRelationResponse> MTNCInfo.DSync.DataSyncSoap.syncOrderRelationAsync(MTNCInfo.DSync.syncOrderRelationRequest request) {
            return base.Channel.syncOrderRelationAsync(request);
        }
        
        public System.Threading.Tasks.Task<MTNCInfo.DSync.syncOrderRelationResponse> syncOrderRelationAsync(MTNCInfo.DSync.UserID userID, string spID, string productID, string serviceID, string serviceList, int updateType, string updateTime, string updateDesc, string effectiveTime, string expiryTime, MTNCInfo.DSync.NamedParameterList extensionInfo) {
            MTNCInfo.DSync.syncOrderRelationRequest inValue = new MTNCInfo.DSync.syncOrderRelationRequest();
            inValue.Body = new MTNCInfo.DSync.syncOrderRelationRequestBody();
            inValue.Body.userID = userID;
            inValue.Body.spID = spID;
            ...
            inValue.Body.expiryTime = expiryTime;
            inValue.Body.extensionInfo = extensionInfo;
            return ((MTNCInfo.DSync.DataSyncSoap)(this)).syncOrderRelationAsync(inValue);
        }
    }
}
