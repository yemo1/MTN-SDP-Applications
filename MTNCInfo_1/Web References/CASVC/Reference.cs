...
namespace MTNCInfo.CASVC
{
    ...
    public partial class AmountChargingService : System.Web.Services.Protocols.SoapHttpClientProtocol
    {
        ...
        {
            this.Url = string.Format(global::MTNCInfo.Properties.Settings.Default.MTNNWeb_CASVC_AmountChargingService, ((AppUtil.TestMode == 0) ? AppUtil.LiveIP : AppUtil.TestIP));
