...
namespace MTNCInfo.OTPSVC {
    ...
    public partial class SubscriberConsentService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public SubscriberConsentService() {
            this.Url = string.Format(global::MTNCInfo.Properties.Settings.Default.MTNCInfo_OTPSVC_SubscriberConsentService, ((AppUtil.TestMode == 0) ? AppUtil.LiveIP : AppUtil.TestIP));
