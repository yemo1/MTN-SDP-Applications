...
namespace MTNCInfo.CASVC {
    ...
    public partial class AmountChargingService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public AmountChargingService() {
            this.Url = string.Format(global::MTNCInfo.Properties.Settings.Default.MTNCInfo_CASVC_AmountChargingService, ((AppUtil.TestMode == 0) ? AppUtil.LiveIP : AppUtil.TestIP));
