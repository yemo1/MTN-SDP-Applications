...
namespace MTNCInfo
{
    public partial class AuthWeb : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                //http://368795-web2/MTNNWeb/AuthWeb.aspx?sID='+@svcID+'&pID='+@pID+'&phone='+@MSISDN+'&amt='+CAST(@ServiceCharge as varchar)
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                appsg.frequency = "0";  //Was "1" before confirmation changes 17/12/2015
                                ...
                                appsg.extensionInfo = extInfList(amt); //Change effected here
        ...
        private AUTHSVC.NamedParameter[] extInfList(int amount)
        {
            AUTHSVC.NamedParameter[] extList = new AUTHSVC.NamedParameter[20];
            AUTHSVC.NamedParameter ext = new AUTHSVC.NamedParameter();
            ...
            ext = new AUTHSVC.NamedParameter();
            ext.key = "tokenType";
            ext.value = "0";   //One -off token //Was 1 before now-17/12/2015
