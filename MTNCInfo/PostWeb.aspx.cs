                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                accesstoken = Request.QueryString["atk"].ToString();
                                ...
                                authentication.oauth_token = accesstoken;  //17/12/2015
                                ...
                                casg.charge.currency = "XAF";
                                
                                
                                //casg.charge.code = "566"; not require for now
                                casg.endUserIdentifier = msisdn; //"+" + msisdn; //17/12/2015 
